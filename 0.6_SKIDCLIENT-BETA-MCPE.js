...
var logNum = 1;
 ...
 MenuBtn();
print("Welcome "+ Player.getName(Player.getEntity()) +" to skidclient 0.6 BETA MCPE! Check for updates at http://www.skidclient.weebly.com/ refreshscript:p:p:p:P;pp;p;p;p;p;p;p;p;pp;;p;pp;");
...
print("WARNING: A refresh script or whatever you'd like to call it has been added! IT MAY NOT WORK AS EXPECTED.");
}
...
var modpeFile = new java.io.File(modpeFolder, "0.6_SKIDCLIENT-MCPE.js");
...
function refresh(){
net.zhuoweizhang.mcpelauncher.ScriptManager.setEnabled("0.6_SKIDCLIENT-MCPE.js", true);
}